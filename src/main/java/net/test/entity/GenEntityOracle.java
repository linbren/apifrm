...
public class GenEntityOracle {
    ...
    private String packageOutPath = "net.business.monitor.entity";//指定实体生成所在包的路径
    private String authorName = "Ethan";//作者名字
    private String tablename = "monitor_events";//表名
    ...
    //数据库连接
     private static final String URL ="jdbc:oracle:thin:@127.0.0.1:1521:fjqxj";
     private static final String NAME = "fjqxj";
     private static final String PASS = "fjqxj";
...
//              String outputPath = directory.getAbsolutePath()+ "/src/"+path.substring(path.lastIndexOf("/com/", path.length()), path.length()) + initcap(tablename) + ".java";
                String outputPath = directory.getAbsolutePath()+ "/src/"+this.packageOutPath.replace(".", "/")+"/"+stable + ".java";
